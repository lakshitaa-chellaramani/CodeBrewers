    ...
    <div className='bg-[#f7fdfd]'>
      ...
      >
        <div className='w-full z-10'>
          <div className='mb-8'>
            <p className='text-slate-700 text-center font-bold text-4xl'>{title}</p>
          </div>

          <div className='max-w-[50%] mx-auto flex items-center justify-around bg-white px-2 md:px-5 py-2.5 md:py-6 shadow-2xl rounded-full'>
            <SearchInput
